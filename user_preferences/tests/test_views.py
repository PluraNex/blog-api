...
class NotificationSettingsViewTest(BaseTestSetup, APITestCase):
    ...
    def test_put_invalid_data(self):
        ...
        """
        invalid_data = {
            'notify_on_like': "invalid",  # Valor inválido que deve ser booleano
            'notify_on_comment': False,
            'notify_on_new_follower': True,
            'notify_on_milestone': False
        }
        ...
        self.assertIn("notify_on_like", response.data)  # Verifica se o erro está relacionado ao campo inválido
    ...
    def test_patch_invalid_data(self):
        ...
        """
        invalid_data = {'notify_on_like': "invalid"}  # Valor inválido que deve ser booleano
